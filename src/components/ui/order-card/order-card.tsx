...
// import { Link } from 'react-router-dom'; // больше не нужен
import {
  CurrencyIcon,
  FormattedDate
...
export const OrderCardUI: FC<OrderCardUIProps & { onClick?: () => void }> =
  memo(({ orderInfo, maxIngredients, locationState, onClick }) => {
    // Для доступности: обработка Enter/Space
    ...
    return (
      <div
        ...
        aria-label={`Открыть заказ #${orderInfo.number}`}
      >
